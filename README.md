...
13. 在人物档案中完善角色：填写形象介绍与生平，并可为同一角色添加多张人物图（不同风格或姿态）
14. （可选）使用下载小说：左侧菜单进入「下载小说」，选择书源、输入书名或作者搜索，选中书籍后可「下载并加入书架」或「导出为 TXT」，操作区悬浮在页面底部便于查看进度
...
5. 使用下载小说功能：多书源搜索后下载到本地或导出 TXT，用于阅读参考与个人备份（请遵守版权与当地法规）
6. 结合地图设计构建世界观
   - 使用形状工具绘制精确的地形边界
   - 使用文字工具添加地名标注
   - 利用资源图标快速构建地图元素
...
7. 利用随机名字生成器丰富角色
   ...
   - 利用批量生成功能，快速筛选合适的名字
8. 为书架设置密码保护，确保所有数据安全
9. 使用关系图谱的头像功能增强视觉效果
10. 建立完整的词条字典体系，分类管理故事中的专有名词、地名、组织等
11. 在编辑器中开启禁词提示，实时检测并标记敏感词汇
12. 使用人物高亮功能，快速定位角色在文本中的出现位置
13. 查看内置用户指南，了解更多高级功能和技巧
...
- **关键词**: 桌面应用、富文本编辑、Canvas 绘图、关系图谱、小说写作、词条字典、禁词检测、人物高亮、AI辅助、AI封面、AI人物图、AI写作、智能起名、人物谱、下载小说、多书源
...
<span id="标签"></span>
## 🏷️ 标签
`#Electron` `#Vue3` `#桌面应用` `#富文本编辑` `#Canvas绘图` `#关系图谱` `#小说写作` `#人物谱` `#前端开发` `#词条字典` `#禁词检测` `#人物高亮` `#AI辅助` `#AI写作` `#通义万相` `#DeepSeek` `#智能起名` `#下载小说`
