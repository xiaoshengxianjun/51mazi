# 写小说也能「所见即所得」？51 码字把正文选段变成 AI 场景图

> **写给爱写小说的你**：环境写了半页，脑子里有画面，手里却没有一张能看的图——约稿贵、自己不会画、搜图又怕版权。**51 码字（51mazi）** 是面向小说作者的**开源**桌面写作软件，**官网**：[www.51mazi.com](https://www.51mazi.com)。最近在章节编辑器里上线了 **「AI 场景图」**：在正文里**划选一段**描写，点一下就能生成**与文字氛围相近**的场景插图，图片**自动保存**到本书文件夹，路径一目了然。  
...
![51码字 AI 场景图：编辑器选中文本 + 右侧抽屉生成场景插图](https://raw.githubusercontent.com/xiaoshengxianjun/51mazi/main/static/ai_scene.png)
...
- [写小说也能「所见即所得」？51 码字把正文选段变成 AI 场景图](#写小说也能所见即所得51-码字把正文选段变成-ai-场景图)
  - [📸 先看效果](#-先看效果)
  - [📋 目录](#-目录)
...
- ⭐ **点个 Star**：[GitHub - 51mazi / 51码字](https://github.com/xiaoshengxianjun/51mazi)  
...
`#小说写作` `#51码字` `#开源` `#Electron` `#Vue3` `#AI绘画` `#文生图` `#通义万相` `#DeepSeek` `#写作软件` `#创作工具`
...
> 本文为基于 **51 码字（51mazi）** 中「AI 场景图」功能的整理，转载请注明项目出处与开源协议。
