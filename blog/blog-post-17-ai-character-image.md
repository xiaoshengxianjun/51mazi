...
这样，**生成态**和**已采纳态**在磁盘上界限清晰，便于维护和排查。**51mazi 的目录与状态设计非常清晰**，作者无需关心临时文件，开发者也能快速定位逻辑。
...
- **⭐ GitHub 仓库**：[https://github.com/xiaoshengxianjun/51mazi](https://github.com/xiaoshengxianjun/51mazi) —— **如果 51mazi 对你有帮助，请给个 Star，让更多写作者发现它！**
